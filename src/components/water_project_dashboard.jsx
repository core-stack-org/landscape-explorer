...
const WaterProjectDashboard = () => {
  ...
  useEffect(() => {
    ...
    const matchedFeatureIndex = geoData.features.findIndex(
      (f) => f.properties?.UID?.toString() === waterbodyParam.toString()
    );
  ...
  const {
    ...
    const mappedRows = geoData.features.map((feature, index) => {
      ...
      return {
        ...
        UID: props.UID || "NA",
        areaOred: props.area_ored || 0,
        interventionYear: config.interventionYear ?? "—",
        maxCatchmentArea: props.max_catchment_area || 0,
        maxStreamOrder: props.max_stream_order || 0,
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="absolute top-32 left-6 z-50 flex flex-col items-start text-white font-bold sm:top-28 md:top-32">
        {/* Toggle Button Group */}
          ...
          loadingData ? (
            ...
            <>
              <TopSection configTextFn={config.topSectionText} data={{projectName: project?.label,
                  tehsilName: mode === "tehsil" ? selectedBlockName : null, totalRows,totalSiltRemoved,
          ...
          <div className="flex flex-col gap-4 mt-2 w-full px-2 sm:px-4 md:px-6">
            ...
            <div className="flex flex-col md:flex-row items-start gap-4 w-full">
              <div className={`relative ${selectedWaterbody ? "w-full md:w-[65%]" : "w-full"}`}>
                ...
                <DashboardBasemap id="map1" mode="waterbody" geoData={geoData} selectedWaterbody={selectedWaterbody}lulcYear={lulcYear1} projectName={project?.label} projectId={project?.value} onSelectWaterbody={(data) => {
                ...
                {selectedWaterbody && (
                  <div  className="absolute top-4 left-4 bg-white/90 p-2 sm:p-3 rounded-md font-bold shadow flex flex-col items-start gap-1 z-[1000] max-w-[90%] sm:max-w-[300px]">
                    ...
                    <p className="text-gray-700 text-sm font-semibold">
                      Silt Removed: {selectedWaterbody?.siltRemoved || "silt"}{" "} cubic metres
                    </p>
              ...
              {selectedWaterbody && (
                <div className="relative w-full h-[85vh]">
                  ...
                  <DashboardBasemap
                    ...
                    lulcYear={lulcYear2} // optional, not used in mws but harmless
                    projectName={projectName}
                    projectId={projectId}
