...
const LeftSidebar = ({ onClose }) => {
  ...
  return (
    <div className="bg-gray-800 w-96 h-full overflow-auto flex flex-col">
      ...
      <div className="p-3 mt-2 grid grid-cols-1 gap-2">
      ...
      <div className="p-4 bg-gray-900 rounded-md mx-3 mt-2">
        ...
        <div className="text-gray-300 flex-col">
          ...
          <div className="flex flex-wrap gap-2 mt-4 justify-center">
            <a 
              ...
              className="bg-blue-600 px-3 py-2 rounded-md text-white text-sm hover:bg-blue-700 transition"
            >
              KNOW MORE
            </a>
            {layerDetail[currTab]["style_url"].map((item, index) => (
              <button 
                key={index}
                className="bg-green-600 px-3 py-2 rounded-md text-white text-sm hover:bg-green-700 transition"
      ...
      {currSection !== "NREGA Layer" ? (
        <div className="mt-4">
          <h4 className="text-lg font-semibold text-white px-4 py-2 bg-gray-700">
