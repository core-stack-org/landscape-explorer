...
const ToggleOnIcon = () => (
  <span className="px-2 py-0.5 bg-[#8B5CF6] text-white text-xs font-medium rounded-full">
    ON
  </span>
);

const ToggleOffIcon = () => (
  <span className="px-2 py-0.5 bg-[#EDE9FE] text-[#8B5CF6] text-xs font-medium rounded-full">
    OFF
  </span>
);
...
const handleStyleDownload = (layerName) => {
  ...
  switch (layerName) {
    case "afforestation":
      url =
        "https://drive.google.com/file/d/10RvFu28sIa-OpQvJ2z6D8-V5RROUUeZz/view?usp=drive_link";
      break;
    case "deforestation":
      url =
        "https://drive.google.com/file/d/1MFKAXiW5mpfCoBBMJR-K7Y5O_Uwp0kOR/view?usp=drive_link";
      break;
    case "terrain_vector":
      url =
        "https://drive.google.com/file/d/1RTogX5nacJYQLP2IFMQiQEBrQyyqPf-G/view?usp=sharing";
      break;
    case "degradation":
      url =
        "https://drive.google.com/file/d/1tPtEqhWO_RisycKnK8Bl_2yEnrfgWqfE/view?usp=drive_link";
      break;
    case "urbanization":
      url =
        "https://drive.google.com/file/d/16JHaWXxdq5y-g2wr5D_f7OB70jiA9QuA/view?usp=sharing";
      break;
    case "cropintensity":
      url =
        "https://drive.google.com/file/d/13cgF1Cg6YWZMCQXH7XV7cITxsg9v2SBu/view?usp=sharing";
      break;
    case "restoration":
      url =
        "https://drive.google.com/file/d/1JANwwxGDpy5vUkM2v8wqJDUKbVS8I72u/view?usp=sharing";
      break;
    case "clart":
      url =
        "https://drive.google.com/file/d/1B8ibmiv8dBNYZZ1gZWIp4AQPdu82t1yl/view?usp=drive_link";
      break;
    case "drainage":
      url =
        "https://drive.google.com/file/d/1s57ufrKk_iKWxIJTpy_S1Yt3nQD0DMjc/view?usp=drive_link";
      break;
    case "terrain":
      url =
        "https://drive.google.com/file/d/1gMh9Dj3ICJuw1vqgP9vEI9oIU_PLNsPs/view?usp=sharing";
      break;
    case "lulc_level_1":
      url =
        "https://drive.google.com/file/d/1mIVKi9N5QQI3QqFYj9y8uJGet5oRAVqA/view?usp=sharing";
      break;
    case "lulc_level_2":
      url =
        "https://drive.google.com/file/d/1q7Tzs7zwn3T4jhRqqYc7RgCNAktkWa9m/view?usp=drive_link";
      break;
    case "lulc_level_3":
      url =
        "https://drive.google.com/file/d/1GFc7W2AtlrYJbnveWkT08uSyeTasFQxT/view?usp=drive_link";
      break;
    case "soge":
      url =
        "https://drive.google.com/file/d/1iSgiTZOCxQ6t0tYVgVSI059Cz-3YimuR/view?usp=sharing";
      break;
    case "aquifer":
      url =
        "https://drive.google.com/file/d/1xHjtq893yQcCfBsuQ0G_SKko111xkv6F/view?usp=sharing";
      break;
    case "drought":
      url =
        "https://drive.google.com/file/d/1BIDbbsLaFxBO4YHMX-vyEt0VTSJLLlmL/view?usp=sharing";
      break;
    case "cropping_intensity":
      url =
        "https://drive.google.com/file/d/1cAZBQu4DUUPUS3u3VZtCzK4PYuSDgflW/view?usp=sharing";
      break;
    case "mws_layers":
    ...
    case "cropIntensity":
      url =
        "https://drive.google.com/file/d/1OkjCjs2RF0kLCMpgnM3REE4of1GpDisn/view?usp=sharing";
      break;
    case "tree_overall_ch":
      url =
        "https://geoserver.core-stack.org:8443/geoserver/tree_overall_ch/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=tree_overall_ch:overall_change_vector_${districtFormatted}_${blockFormatted}&outputFormat=application/json&screen=main";
  }
        ...
        <div className="flex mt-2 space-x-2">
          {layer.hasGeojson && (
            <DownloadButton
              name="GeoJSON"
              onClickEvent={() =>
                onDownload(layer.name, "geojson", ccdYear.value)
              }
              isDisabled={!isLayersFetched || isLoading}
            />
          )}
          {layer.hasKml && (
            <DownloadButton
              name="KML"
              onClickEvent={() => onDownload(layer.name, "kml", ccdYear.value)}
              isDisabled={!isLayersFetched || isLoading}
            />
          )}
          {layer.hasGeoTiff && (
...
const RightSidebar = ({
  ...
  const handleDownloadClick = (filterName, format, year = null) => {
    if (!district || !block) {
    ...
    if (format === "geojson") {
      ...
      switch (filterName) {
        ...
        case "cropping_intensity":
          ...
          break;
        case "ccd":
          url = `https://geoserver.core-stack.org:8443/geoserver/ccd/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ccd:ccd_vector_${districtFormatted}_${blockFormatted}_${year}&outputFormat=application/json`;
          break;
        case "tree_overall_ch":
      ...
      switch (filterName) {
        ...
        case "cropping_intensity":
          ...
          break;
        case "ccd":
          url = `https://geoserver.core-stack.org:8443/geoserver/ccd/wms?service=WMS&version=1.1.0&request=GetMap&layers=ccd:ccd_raster_${districtFormatted}_${blockFormatted}_${year}&bbox=-180,-90,180,90&width=768&height=768&srs=EPSG:4326&format=application/vnd.google-earth.kml+xml`;
          break;
        case "tree_overall_ch":
  ...
  const handleLocalExcelDownload = () => {
    ...
    if (handleExcelDownload) {
      ...
      downloadExcel(url, `${block.label}_data.xlsx`).finally(() => {
            ...
            {selectedCategory === "restore" && (
              <div>
                {restorationLayersData.map((layer) => {
                  if (layer.id === "ccd_year") {
                    return (
                      <CcdSelector
                        key={layer.id}
                        layer={layer}
                        ccdYear={ccdYear}
                        setCcdYear={setCcdYear}
                        onDownload={handleDownloadClick}
                        isLayersFetched={isLayersFetched}
                        isLoading={isLoading}
                      />
