  ...
  return (
    <div className={isOpen ? styles.wrapper_show : styles.wrapper_hide}>
      <div className={styles.top_menu_wrapper}>
        <label
          className="bg-[#00286D]  rounded-md p-1 cursor-pointer flex justify-center hover:bg-opacity-90"
      ...
      <div className={isOpen ? styles.m_menu_visible : styles.m_menu}>
        <div className={styles.m_menu__header}>
          ...
          <span>
            <img src={landscape_icon} className="w-8 h-8" />
            {"Landscape Explorer"}
          </span>
        ...
        <div className="flex-col p-3">
          <div className="text-md font-semibold text-slate-200 p-1 underline underline-offset-4">
            {currSection}
          </div>
          <div className="text-slate-200 p-5 flex-col">
            ...
            <button
              className="bg-[#746D6D] p-3 rounded-xl text-[#EAEAEA] text-xs shadow-2xl mt-2"
              onClick={(event) =>
                (window.location.href =
                  "https://gitlab.com/corestack.org/corestack")
              }
            >
              KNOW MORE
            </button>
            {layerDetail[currTab]["style_url"].map((item) => {
              return (
                <button
                  className="bg-[#746D6D] p-3 rounded-xl text-[#EAEAEA] text-xs shadow-2xl mt-2 ml-2"
        ...
        {currSection !== "NREGA Layer" ? (
          <>
            <span className="font-semibold text-slate-200 p-3 underline text-md underline-offset-4">
            ...
            <div className="flex-col p-5 overflow-y-scroll h-48 mt-1 mr-9">
              <div className="flex items-center p-1">
                ...
                <span className="text-slate-200 font-thin text-md pl-3">
                  Well Marker
                </span>
              </div>
              <div className="flex items-center p-1">
