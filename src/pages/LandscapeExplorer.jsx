...
const LandscapeExplorer = () => {
  ...
  const handleItemSelect = (setter, value) => {
    ...
    else if (setter === setSelectedPlan) {
      setSelectedPlan(value);
      // Auto-fetch resources/planning layers based on active category
        ...
        <div className="flex-1 relative p-2">
          {!showLeftSidebar && (
            <button 
              ...
              className="absolute top-4 left-4 z-10 bg-green-600 p-2 rounded-md shadow-md text-white hover:bg-green-700 transition-colors"
            >
